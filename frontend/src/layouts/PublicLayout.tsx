  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-100/70 text-medical-dark relative selection:bg-primary selection:text-white">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[1200px] h-[500px] bg-gradient-to-b from-primary/15 via-primary-light/30 to-transparent blur-3xl opacity-70" />
      </div>
      ...
      <div className="relative z-10 flex flex-col flex-1 w-full">
        ...
        {/* 
          En 'home' liberamos el 100% del ancho para banners y franjas full-width.
          En las demás pestañas mantenemos el contenedor centrado para tablas y filtros.
        */}
        ...
        <footer className="border-t border-slate-800 bg-[#07273B] text-slate-300 mt-16 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-slate-700/60 text-xs">
              ...
              <div className="space-y-3 md:col-span-2">
                <div className="flex items-center gap-3">
                  <img
                    ...
                    alt="Isotipo Medical & Biosecurity"
                    className="h-10 w-10 object-contain drop-shadow-sm"
                  />
                  <div>
                    <span className="block font-bold text-white text-base tracking-wide font-sans">
                      Medical & Biosecurity
                    </span>
                ...
                <p className="text-slate-400 max-w-sm leading-relaxed text-[11px]">
                  Confección especializada de indumentaria médica bajo la línea <strong>Indumedics</strong> y distribución mayorista de dispositivos y consumibles clínicos en Quito y a nivel nacional.
                </p>
              </div>

              {/* Columna 2: Navegación de Catálogos */}
              <div className="space-y-2">
                ...
                <ul className="space-y-1.5 text-slate-400">
                  <li>
                    <button onClick={() => onTabChange('clothing')} className="hover:text-primary transition-colors cursor-pointer text-left">
                  ...
                  <li>
                    <button onClick={() => onTabChange('supplies')} className="hover:text-primary transition-colors cursor-pointer text-left">
